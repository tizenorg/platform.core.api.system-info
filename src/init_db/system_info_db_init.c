...
static int system_info_update_db(int argc, char *argv[])
{
	...
	/* http://www.hep.by/gnu/gdbm/Open.html
	 * If flags is set to ‘GDBM_WRITER’, the user wants both read and write access
	 * to the database and requires exclusive access */
